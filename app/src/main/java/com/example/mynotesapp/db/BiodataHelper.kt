...
class BiodataHelper(context: Context) {
    ...
    companion object {
        ...
        private var INSTANCE: BiodataHelper? = null

        fun getInstance(context: Context): BiodataHelper =
            INSTANCE ?: synchronized(this) {
                INSTANCE ?: BiodataHelper(context)
            }
    }

    @Throws(SQLException::class) //test
    fun open() {
